...
4. Ask a human Tester other than the implementing agent to replay the file and record their name or role, date, and audible PASS/FAIL in `EXPERIMENT.md`. The repository owner may serve as that Tester. A MOD completion message alone does not count.
