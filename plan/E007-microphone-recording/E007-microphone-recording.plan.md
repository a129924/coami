...
- **Current**: `publish-in-progress`; **Next actor**: Main Agent; **Stage-local action**: commit the owner-approved E007 staged set, then publish the shared feature branch and open one draft PR for human review.
...
| Written evidence | `experiments/E007-microphone-recording/evidence/recording-run.md` | Creator records; Tester verifies |
